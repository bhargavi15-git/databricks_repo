...
df1=spark.sql("SHOW TABLES IN workspace.default").select("tableName").where("tableName!='_sqldf'")
print(df1.collect())
tables = [r.tableName for r in df1.collect()]

dbutils.widgets.dropdown("table_name","customer",tables)
